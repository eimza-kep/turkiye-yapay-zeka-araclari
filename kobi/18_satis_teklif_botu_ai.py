...
# -*- coding: utf-8 -*-
"""
18_satis_teklif_botu_ai.py
--------------------------
WhatsApp ve web üzerinden gelen müşteri taleplerinden anında
iskontolu, KDV dahil Proforma Fatura ve Fiyat Teklifi üreten AI.
"""
...
TOOL_KEY = "18_satis_teklif_botu_ai"
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Müşteri Talep Mesajı:\n{content}\n")
    print(f"🤖 Yapay Zeka Kurumsal Fiyat Teklifi / Proforma Oluşturuyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Müşteri mesajı veya dosya yolu")
