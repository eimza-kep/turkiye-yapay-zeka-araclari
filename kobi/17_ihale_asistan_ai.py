...
# -*- coding: utf-8 -*-
"""
17_ihale_asistan_ai.py
----------------------
EKAP ve kamu ihale şartnamelerinden teminat oranlarını,
zorunlu iş deneyim belgelerini ve riskli cezai şartları özetleyen AI.
"""
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 İhale Şartname Metni:\n{content}\n")
    print(f"🤖 Yapay Zeka İhale Şartlarını ve Risklerini Çıkarıyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Şartname metni veya dosya yolu")
