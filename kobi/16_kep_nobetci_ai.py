...
# -*- coding: utf-8 -*-
"""
16_kep_nobetci_ai.py
--------------------
Şirket KEP kutusuna gelen İİK 89/1 Haciz İhbarnameleri ve resmi
adli yazıları analiz ederek 7 günlük itiraz süresini takip eden AI.
"""
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 KEP Resmi Yazı Metni:\n{content}\n")
    print(f"🤖 Yapay Zeka Haciz ve Yasal Süre Analizini Yapıyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="KEP tebligat metni veya dosya yolu")
