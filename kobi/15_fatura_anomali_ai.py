...
# -*- coding: utf-8 -*-
"""
15_fatura_anomali_ai.py
-----------------------
Gelen e-Fatura ve e-Arşiv listelerindeki olağandışı fiyat artışlarını,
mükerrer ödeme şüphelerini ve kaçakları yakalayan yapay zeka aracı.
"""
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Fatura Kalemleri Listesi:\n{content}\n")
    print(f"🤖 Yapay Zeka Anomali ve Fiyat Artış Taraması Yapıyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Fatura listesi metni veya dosya yolu")
