...
# -*- coding: utf-8 -*-
"""
20_reklam_uyum_ai.py
--------------------
Ticaret Bakanlığı Reklam Kurulu ve Tüketici Kanunu cezalarını önlemek için
sosyal medya ve e-ticaret reklam metinlerini denetleyen yapay zeka aracı.
"""
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Reklam / Kampanya Metni:\n{content}\n")
    print(f"🤖 Yapay Zeka Reklam Kurulu Mevzuat Denetimini Yapıyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Reklam metni veya dosya yolu")
