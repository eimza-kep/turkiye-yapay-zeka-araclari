...
# -*- coding: utf-8 -*-
"""
19_tesvik_radar_ai.py
---------------------
KOBİ'lerin NACE kodu, çalışan sayısı ve yatırım hedeflerine göre
o an açık olan KOSGEB ve TÜBİTAK devlet hibelerini eşleştiren yapay zeka.
"""
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Şirket ve Yatırım Bilgileri:\n{content}\n")
    print(f"🤖 Yapay Zeka Güncel Devlet Destekleri ve Hibeleri Eşleştiriyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Şirket bilgisi ve yatırım planı")
