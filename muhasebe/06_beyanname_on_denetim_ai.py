...
# -*- coding: utf-8 -*-
"""
06_beyanname_on_denetim_ai.py
-----------------------------
KDV-1, KDV-2, Muhtasar ve Geçici Vergi taslakları arasında
çapraz uyumsuzlukları ve vergi ceza risklerini denetleyen yapay zeka.
"""
...
TOOL_KEY = "06_beyanname_on_denetim_ai"
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Beyanname Taslak Verileri:\n{content}\n")
    print(f"🤖 Yapay Zeka Çapraz Denetim ve Risk Taraması Yapıyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Beyanname taslak metni veya dosya yolu")
