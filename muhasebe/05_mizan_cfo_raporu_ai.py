...
# -*- coding: utf-8 -*-
"""
05_mizan_cfo_raporu_ai.py
-------------------------
Mizan ve mali tablolardan patronun ve yönetim kurulunun
anlayacağı sade, rasyolu 2 sayfalık yönetici raporu yazan AI.
"""
...
TOOL_KEY = "05_mizan_cfo_raporu_ai"
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Mizan ve Mali Veriler:\n{content}\n")
    print(f"🤖 Yapay Zeka CFO Yönetici Raporunu Hazırlıyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Mizan metni veya dosya yolu")
