...
01_fismatik_ai.py
-----------------
Fiş/Fatura metninden veya görselinden Tekdüzen Hesap Kodlarıyla
otomatik yevmiye maddesi üreten yapay zeka aracı.
"""
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Girdi Metni:\n{content}\n")
    print(f"🤖 Yapay Zeka Analiz Ediyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="İncelenecek fiş/fatura metni veya dosya yolu")
