...
# -*- coding: utf-8 -*-
"""
04_banka_ekstresi_ai.py
-----------------------
Banka hesap ekstresi satırlarını analiz ederek
cari hesap ve Tekdüzen yevmiye kodlarıyla eşleştiren yapay zeka aracı.
"""
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Ekstre Satırları:\n{content}\n")
    print(f"🤖 Yapay Zeka Satırları Yevmiye Kodlarıyla Eşleştiriyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Banka ekstre satırları veya dosya yolu")
