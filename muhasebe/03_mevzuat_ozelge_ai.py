...
# -*- coding: utf-8 -*-
"""
03_mevzuat_ozelge_ai.py
-----------------------
GİB Özelgeleri ve Türk Vergi Kanunları (VUK, GVK, KVK, KDVK)
esas alınarak vergi sorularını yanıtlayan yapay zeka danışmanı.
"""
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Vergi Sorusu:\n{content}\n")
    print(f"🤖 Yapay Zeka Özelge ve Mevzuat Taraması Yapıyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Vergi veya mevzuat sorusu")
