...
# -*- coding: utf-8 -*-
"""
08_sozlesme_denetleyici_ai.py
-----------------------------
Sözleşme maddelerindeki tek taraflı cezai şartları ve riskleri tarayan,
yerine müvekkili koruyan 'Redline Revize Madde' öneren yapay zeka aracı.
"""
...
TOOL_KEY = "08_sozlesme_denetleyici_ai"
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Sözleşme Maddesi:\n{content}\n")
    print(f"🤖 Yapay Zeka Hukuki Riskleri ve Redline Revizyonunu Çıkarıyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Sözleşme metni veya dosya yolu")
