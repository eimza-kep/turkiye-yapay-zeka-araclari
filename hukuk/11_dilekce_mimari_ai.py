...
# -*- coding: utf-8 -*-
"""
11_dilekce_mimari_ai.py
-----------------------
6100 Sayılı HMK ve UYAP standartlarında dava ve cevap
dilekçesi taslağı üreten yapay zeka hukuk asistanı.
"""
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 Olay ve Dava Bilgileri:\n{content}\n")
    print(f"🤖 Yapay Zeka HMK Uyumlu Dava Dilekçesi Taslağını Hazırlıyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="Olay ve talep özeti veya dosya yolu")
