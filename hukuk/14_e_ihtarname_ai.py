...
# -*- coding: utf-8 -*-
"""
14_e_ihtarname_ai.py
--------------------
TTK Madde 18/3 ve Borçlar Kanunu standartlarında,
KEP üzerinden noter masrafsız gönderilebilir resmi ihtarname üreten AI.
"""
...
def run_tool(input_text=None, mock=False, api_key=None, provider=None):
    ...
    print(f"===============================================================================\n")
    print(f"📥 İhtarname Bilgileri:\n{content}\n")
    print(f"🤖 Yapay Zeka KEP Uyumlu Resmi İhtarname Metnini Oluşturuyor...\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("input", nargs="?", default=None, help="İhtar detayları veya dosya yolu")
